...
const content = {
  uk: {
    ...
    heading: "Готові до системного SMM?",
    sub: "Залиште заявку — розберемось у вашій ніші і скажемо чесно, чи підійде наш пакет для вашого бізнесу.",
    doneTitle: "Дякуємо!",
    ...
    businessPlaceholder: "Наприклад: ресторан, бутік, стоматологія...",
  ...
  en: {
    ...
    heading: "Ready for systematic SMM?",
    sub: "Submit a request — we'll look into your niche and tell you honestly whether our bundle fits your business.",
    doneTitle: "Thank you!",
    ...
    businessPlaceholder: "For example: restaurant, boutique, dental clinic...",
